...
register("catalog.create_smart_collection", CollectionActions.createSmartCollection)
register("catalog.get_smart_collection_rules", CollectionActions.getSmartCollectionRules)
register("catalog.update_smart_collection", CollectionActions.updateSmartCollection)
